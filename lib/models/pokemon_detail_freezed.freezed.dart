...
abstract class $PokemonDetailFreezedCopyWith<$Res> {
  factory $PokemonDetailFreezedCopyWith(PokemonDetailFreezed value,
...
/// @nodoc
class _$PokemonDetailFreezedCopyWithImpl<$Res,
...
abstract class _$$PokemonDetailFreezedImplCopyWith<$Res>
    implements $PokemonDetailFreezedCopyWith<$Res> {
  factory _$$PokemonDetailFreezedImplCopyWith(_$PokemonDetailFreezedImpl value,
...
class __$$PokemonDetailFreezedImplCopyWithImpl<$Res>
  ...
  __$$PokemonDetailFreezedImplCopyWithImpl(_$PokemonDetailFreezedImpl _value,
  ...
  $Res call({
    ...
    return _then(_$PokemonDetailFreezedImpl(
      id: null == id
          ? _value.id
          : id // ignore: cast_nullable_to_non_nullable
              as int,
...
class _$PokemonDetailFreezedImpl extends _PokemonDetailFreezed {
  ...
  Map<String, dynamic> toJson() {
    return _$$PokemonDetailFreezedImplToJson(
      this,
    );
  }
}
...
abstract class $PokemonTypeFreezedCopyWith<$Res> {
  factory $PokemonTypeFreezedCopyWith(
          PokemonTypeFreezed value, $Res Function(PokemonTypeFreezed) then) =
...
abstract class _$$PokemonTypeFreezedImplCopyWith<$Res>
    implements $PokemonTypeFreezedCopyWith<$Res> {
  factory _$$PokemonTypeFreezedImplCopyWith(_$PokemonTypeFreezedImpl value,
...
class __$$PokemonTypeFreezedImplCopyWithImpl<$Res>
  ...
  __$$PokemonTypeFreezedImplCopyWithImpl(_$PokemonTypeFreezedImpl _value,
  ...
  $Res call({
    ...
    return _then(_$PokemonTypeFreezedImpl(
      slot: null == slot
          ? _value.slot
          : slot // ignore: cast_nullable_to_non_nullable
              as int,
...
class _$PokemonTypeFreezedImpl implements _PokemonTypeFreezed {
  ...
  @override
  Map<String, dynamic> toJson() {
    return _$$PokemonTypeFreezedImplToJson(
      this,
    );
  }
}
...
abstract class _PokemonTypeFreezed implements PokemonTypeFreezed {
  const factory _PokemonTypeFreezed(
      ...
      required final TypeInfoFreezed type}) = _$PokemonTypeFreezedImpl;
...
abstract class $TypeInfoFreezedCopyWith<$Res> {
  factory $TypeInfoFreezedCopyWith(
          TypeInfoFreezed value, $Res Function(TypeInfoFreezed) then) =
...
abstract class _$$TypeInfoFreezedImplCopyWith<$Res>
    implements $TypeInfoFreezedCopyWith<$Res> {
  factory _$$TypeInfoFreezedImplCopyWith(_$TypeInfoFreezedImpl value,
...
class __$$TypeInfoFreezedImplCopyWithImpl<$Res>
  ...
  __$$TypeInfoFreezedImplCopyWithImpl(
      _$TypeInfoFreezedImpl _value, $Res Function(_$TypeInfoFreezedImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$TypeInfoFreezedImpl(
      name: null == name
          ? _value.name
          : name // ignore: cast_nullable_to_non_nullable
              as String,
...
class _$TypeInfoFreezedImpl implements _TypeInfoFreezed {
  ...
  @override
  Map<String, dynamic> toJson() {
    return _$$TypeInfoFreezedImplToJson(
      this,
    );
  }
}
...
abstract class _TypeInfoFreezed implements TypeInfoFreezed {
  const factory _TypeInfoFreezed(
      {required final String name,
      required final String url}) = _$TypeInfoFreezedImpl;
...
abstract class $PokemonStatFreezedCopyWith<$Res> {
  factory $PokemonStatFreezedCopyWith(
          PokemonStatFreezed value, $Res Function(PokemonStatFreezed) then) =
...
abstract class _$$PokemonStatFreezedImplCopyWith<$Res>
    implements $PokemonStatFreezedCopyWith<$Res> {
  factory _$$PokemonStatFreezedImplCopyWith(_$PokemonStatFreezedImpl value,
...
class __$$PokemonStatFreezedImplCopyWithImpl<$Res>
  ...
  __$$PokemonStatFreezedImplCopyWithImpl(_$PokemonStatFreezedImpl _value,
  ...
  $Res call({
    ...
    return _then(_$PokemonStatFreezedImpl(
      baseStat: null == baseStat
          ? _value.baseStat
          : baseStat // ignore: cast_nullable_to_non_nullable
              as int,
...
class _$PokemonStatFreezedImpl implements _PokemonStatFreezed {
  ...
  @override
  Map<String, dynamic> toJson() {
    return _$$PokemonStatFreezedImplToJson(
      this,
    );
  }
}
...
abstract class _PokemonStatFreezed implements PokemonStatFreezed {
  const factory _PokemonStatFreezed(
      ...
      required final StatInfoFreezed stat}) = _$PokemonStatFreezedImpl;
...
abstract class $StatInfoFreezedCopyWith<$Res> {
  factory $StatInfoFreezedCopyWith(
          StatInfoFreezed value, $Res Function(StatInfoFreezed) then) =
...
abstract class _$$StatInfoFreezedImplCopyWith<$Res>
    implements $StatInfoFreezedCopyWith<$Res> {
  factory _$$StatInfoFreezedImplCopyWith(_$StatInfoFreezedImpl value,
...
class __$$StatInfoFreezedImplCopyWithImpl<$Res>
  ...
  __$$StatInfoFreezedImplCopyWithImpl(
      _$StatInfoFreezedImpl _value, $Res Function(_$StatInfoFreezedImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$StatInfoFreezedImpl(
      name: null == name
          ? _value.name
          : name // ignore: cast_nullable_to_non_nullable
              as String,
...
class _$StatInfoFreezedImpl implements _StatInfoFreezed {
  ...
  @override
  Map<String, dynamic> toJson() {
    return _$$StatInfoFreezedImplToJson(
      this,
    );
  }
}
...
abstract class _StatInfoFreezed implements StatInfoFreezed {
  const factory _StatInfoFreezed(
      {required final String name,
      required final String url}) = _$StatInfoFreezedImpl;
...
abstract class $PokemonSpritesFreezedCopyWith<$Res> {
  factory $PokemonSpritesFreezedCopyWith(PokemonSpritesFreezed value,
...
/// @nodoc
class _$PokemonSpritesFreezedCopyWithImpl<$Res,
...
class __$$PokemonSpritesFreezedImplCopyWithImpl<$Res>
    extends _$PokemonSpritesFreezedCopyWithImpl<$Res,
        _$PokemonSpritesFreezedImpl>
    implements _$$PokemonSpritesFreezedImplCopyWith<$Res> {
  __$$PokemonSpritesFreezedImplCopyWithImpl(_$PokemonSpritesFreezedImpl _value,
  ...
  $Res call({
    ...
    return _then(_$PokemonSpritesFreezedImpl(
      frontDefault: freezed == frontDefault
          ? _value.frontDefault
          : frontDefault // ignore: cast_nullable_to_non_nullable
              as String?,
...
class _$PokemonSpritesFreezedImpl implements _PokemonSpritesFreezed {
  ...
  _$$PokemonSpritesFreezedImplCopyWith<_$PokemonSpritesFreezedImpl>
      get copyWith => __$$PokemonSpritesFreezedImplCopyWithImpl<
          _$PokemonSpritesFreezedImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$PokemonSpritesFreezedImplToJson(
      this,
    );
  }
}
